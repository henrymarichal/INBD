...
#python main.py train INBD  $HOME_DATASET_DIR/train_inputimages.txt   $HOME_DATASET_DIR/train_annotations.txt   --segmentationmodel=checkpoints/segmentationmodel/model.pt.zip   #adjust path
